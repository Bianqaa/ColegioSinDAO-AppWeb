		...
		<form>
			<div class="m-2 p-2">
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control text-primary"
							name="edad" id="edad" value="" min="18" max="120">
					</div>
				</div>

				<!-- control idCurso  -->
				<div class="mb-3 row">
					<label for="idCurso" class="col-sm-2 col-form-label text-primary">ID Curso</label>
					<div class="col-sm-10">
						<select class="form-select text-primary"
							...
							<option value='<%@ include file="/jsp/selectCurso.jsp" %>'></option>
